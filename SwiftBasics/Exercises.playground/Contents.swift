...
let yourSentence = "As a \(nounArray[6]) it is my job to drink \(nounArray[7])"
let yourSillySentence = "As a \(nounArray[index1]) you should buy a \(nounArray[index2])"
//: ### Exercise 2
...
let shoutString2 = "HEY!" + " " + didYouKnowString.uppercased()
//: ### Exercise 3
//: How many characters are in this string? 
let howManyCharacters = "How much wood could a woodchuck chuck if a woodchuck could chuck wood?"
let numberOfChars = howManyCharacters.count
...
//desired output = "$5.67"
var dollarInt =  numOfPennies/100
var cents = numOfPennies%100
var dollarString: String = "$" + "\(dollarInt)" + "." + "\(cents)"
...
let maximumTimeAllowed: Double, startTime: Date
var currentTime: Date , timeRemaining: Double
